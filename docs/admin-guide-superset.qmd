...
## Dump the superset database into the local filesystem 
...
3. Exit the pod shell and copy the dump file into /tmp in the local filesystem
exit
...
4. Lastly, delete the db dump from the superset pod
    ```shell
