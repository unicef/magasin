...
This installation asumes that you already have kubernetes cluster. You can follow this [guide to setup a cluster](./setup-kubernetes.qmd).
...
helm install operator magasin/tenant --namespace magasin-tenant --create-namespace
```
