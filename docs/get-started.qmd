...
You need to have a kubernetes cluster in any [cloud provider](install.qmd#setting-a-cluster-in-major-cloud-providers) or, for testing purposes, you can set up a local kubernetes cluster in your own computer.
...
For **GNU/Linux Debian Like and MacOS**
...
magasin-drill      drillbit-0                                                        0/1     Running     1 (31s ago)     6m33s
magasin-drill      drillbit-1                                                        0/1     Pending     0               6m33s
