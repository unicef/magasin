...
This is the first out of the three steps of the magasin tutorial. Generally, when you are analyzing data, you may want to learn about the data itself. Jupyter notebooks provide a nice and fast user programming interface that allows you to explore the data.
...
[Download dpg-explorations.ipynb example](https://github.com/unicef/magasin/blob/main/examples/dpg-insights/dpg-insights.ipynb){.btn-action-primary .btn-action .btn .btn-outline-primary  role="button"}.
