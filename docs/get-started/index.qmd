...
To run magasin you need to have a kubernetes cluster in any [cloud provider](../install/setup-kubernetes.qmd#setup-a-cluster-in-a-major-cloud-provider) or, for testing purposes, you can set up a local kubernetes cluster in your own computer.
